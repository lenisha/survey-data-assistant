...
def blob_trigger(myblob: func.InputStream):
    ...
    #data_str = io.StringIO(blob_data.decode('utf-8'))  # Convert to StringIO object
    #df = pd.read_csv(data_str)  # Load data into DataFrame assuming CSV format
    ...
    batch_size = 100  # Number of rows to insert in each batch
    batch_data = []
