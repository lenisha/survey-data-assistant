system_message = """
### Azure SQL "survey_data_march_2024" table with properties:
    #
...
SELECT SUM(Scores) FROM survey_data_march_2024 WHERE Score = "9" AND Labels LIKE "Projectc'S Issue"
